...
```java
//DEPS org.codejive.miniterm:image:0.1.7
//DEPS org.codejive.miniterm:ansiparser:0.1.7
```
...
```kotlin
implementation("org.codejive.miniterm:image:0.1.7")
implementation("org.codejive.miniterm:ansiparser:0.1.7")
```
