...
```java
//DEPS org.codejive.miniterm:image:0.2.0
//DEPS org.codejive.miniterm:ansiparser:0.2.0
```
...
```kotlin
implementation("org.codejive.miniterm:image:0.2.0")
implementation("org.codejive.miniterm:ansiparser:0.2.0")
```
